...
import com.example.gest_proy_invest.Exception.CustomeFieldValidationException;
import com.example.gest_proy_invest.Exception.UsernameOrIdNotFound;
import com.example.gest_proy_invest.dto.ChangePasswordForm;
...
public class UserController {
	...
	public String postEditUserForm(@Valid @ModelAttribute("userForm")User user, BindingResult result, Model model) { //?ModelMap model
		if(result.hasErrors()) {
			baseAttributerForUserForm(model, user, TAB_FORM );
			model.addAttribute("editMode","true");
